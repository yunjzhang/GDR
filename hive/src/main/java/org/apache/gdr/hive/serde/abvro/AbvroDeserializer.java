...
class AbvroDeserializer {
    private static final Log LOG = LogFactory.getLog(AbvroDeserializer.class);
    /**
    ...
    private Object deserializePrimitive(Object datum, Schema fileSchema, Schema recordSchema,
        ...
        switch (columnType.getPrimitiveCategory()) {
            ...
            case DECIMAL:
                ...
                int scale = 0;
                try {
                    scale = fileSchema.getJsonProp(AbvroSerDe.AVRO_PROP_SCALE).getIntValue();
                } catch (Exception ex) {
            ...
            case CHAR:
                ...
                int maxLength = 0;
                try {
                    maxLength = fileSchema.getJsonProp(AbvroSerDe.AVRO_PROP_MAX_LENGTH).getValueAsInt();
                } catch (Exception ex) {
