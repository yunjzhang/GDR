...
import org.apache.gdr.mapreduce.AbAsJsonInputFormat;
...
public class AbAsJsonConverterMapReduce extends Configured implements Tool {

    public static void main(String[] args) {
        int exitCode = 1;
        try {
            exitCode = ToolRunner.run(new AbAsJsonConverterMapReduce(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        try {
            ...
            job.setInputFormatClass(AbAsJsonInputFormat.class);
    ...
    private void printUsage() {
        System.out.println("Usage: AbAsJsonConverterMapReduce <in_dir> <out_dir> <dmlfile>");
    }
